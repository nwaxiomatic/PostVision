...
from .filters import (
    FieldsFilter, OrderingFilter, RestrictedChildOfFilter, 
    RestrictedDescendantOfFilter, RestrictedChildOfAndParentFilter,
    SearchFilter)
...
class PagesAPIEndpoint(BaseAPIEndpoint):
    ...
    filter_backends = [
        ...
        RestrictedChildOfAndParentFilter,
        OrderingFilter,
        SearchFilter
    ]
...
class ImagesAPIEndpoint(BaseAPIEndpoint):
    ...
    extra_body_fields = ['title', 'width', 'height', 'file']
    extra_meta_fields = ['tags']
    default_fields = ['title', 'tags', 'file']
    name = 'images'
